        ...
        <div class="container-fluid h-100 d-flex align-items-center justify-content-center">
            <div class="error-container">
                ...
                <div class="error-content d-flex flex-column align-items-center gap-3">
                    <h2 class="error-title mb-0">Chưa đăng nhập</h2>
                    <p class="error-description">
                        Bạn cần đăng nhập để truy cập vào khu vực này. Vui lòng đăng nhập để tiếp tục sử dụng dịch vụ
                        của chúng tôi.
                    </p>

                    <div class="error-actions">
                        <button @click="goToLogin" class="btn btn-danger rounded-1">
                            <i class="fas fa-sign-in-alt me-2"></i>
                            <span>Đăng nhập ngay</span>
                        </button>
                        <button @click="goHome" class="btn btn-secondary rounded-1">
                ...
                <div class="error-footer">
                    <span class="error-code-text">Lỗi 401 - Unauthorized</span>
                </div>
            </div>
        </div>
    </div>
